...
class V7000ISCSIDriver(driver.ISCSIDriver):
    ...
    def do_setup(self, context):
        ...
        # so only do it once.
        if self.configuration.violin_iscsi_target_ips:
            self.gateway_iscsi_ip_addresses = (
    ...
    def create_consistencygroup(self, context, group):
        ...
        """
        return self.common._create_consistencygroup(context, group)
    ...
    def delete_consistencygroup(self, context, group):
        ...
        """
        return self.common._delete_consistencygroup(context, group, self.db)

    def update_consistencygroup(self, context, group,
                                add_volumes=None, remove_volumes=None):
        """Updates a consistencygroup.

        Note:  once a snapshot has been taken of a consistencygroup,
        no more volumes can be added to the group.

        :param context: the context of the caller
        :param group: dict of the group to be updated
        :param add_volumes: a list of volumes to be added
        :param remove_volumes: a list of volumes to be removed
        """
        return self.common._update_consistencygroup(
    ...
    def create_cgsnapshot(self, context, cgsnapshot):
        ...
        :param context: the context of the caller
        :param cgsnapshot: dict containing the snapshot info
        """
        return self.common._create_cgsnapshot(context, cgsnapshot, self.db)
    ...
    def delete_cgsnapshot(self, context, cgsnapshot):
        ...
        :param cgsnapshot: dict containing the snapshot info
        """
        return self.common._delete_cgsnapshot(context, cgsnapshot, self.db)
    ...
    def create_consistencygroup_from_src(self, context, group, volumes,
        ...
        return None, None.
        """
        return self.common._create_consistencygroup_from_src(
